...
- [Glamour CLI A/B](glamour-ab.md): markdown render CPU/RAM before vs after glamour.
- [CLI live display](cli-live-display.md): progress bar, streaming tokens, tps footer.
